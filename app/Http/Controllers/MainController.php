...
class MainController extends Controller
{
     ...
     * message from the incoming request matches a previously received message, it triggers
     * the DelayedMessageService to send scheduled messages and sends an appropriate reply.
     *
    ...
    /**
     * Generate a chat ID based on the provided mobile number.
     *
